...
func create_target_texture() -> void:
	...
	ResourceSaver.save(texture, "res://examples/destruction/target_texture.png")
...
func create_default_cutout_mesh() -> void:
	...
	var texture_path := "res://examples/destruction/target_texture.png"
	...
	# Save the resource
	ResourceSaver.save(cutout_mesh, "res://examples/destruction/default_cutout.tres")
...
"
	...
	var file := FileAccess.open("res://examples/destruction/SOUND_NOTE.txt", FileAccess.WRITE)
	if file:
